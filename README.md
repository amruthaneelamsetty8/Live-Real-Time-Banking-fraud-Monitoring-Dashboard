...
![Live Fraud Monitoring Dashboard](Screenshots/fraud-monitoring.png)
## Technologies Used
...
- Risk scoring measure
- Anomaly detection on trend chart
- Email alerts using Power Automate
- Deployment with On-premises Data Gateway
...
### 3. Live Update Demonstration (Most Important Part)

**Before Adding New Row:**
![Before Adding Row](Screenshots/5_Before_Adding_Row.png)

**After Adding New Fraud Row in SQL:**
![After Adding Row](Screenshots/6_After_Adding_Row.png)
